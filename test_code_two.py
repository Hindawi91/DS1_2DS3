...
df.to_excel ('./TEST - CNN UT - Base Model_Metrics.xlsx', index = False, header=True)
...
df.to_excel ('./TEST - CNN UT - Base Model_CMs.xlsx', index = False, header=True)
...
final.to_excel ('./TEST - CNN UT - Base Model_CMs2.xlsx', index = False, header=True)
